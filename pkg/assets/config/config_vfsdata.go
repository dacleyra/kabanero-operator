...
var assets = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2019, 9, 16, 19, 1, 55, 335776594, time.UTC),
		},
		...
		"/orchestrations/kappnav/0.1": &vfsgen۰DirInfo{
			name:    "0.1",
			modTime: time.Date(2019, 9, 16, 14, 11, 6, 280062227, time.UTC),
		},
		...
		"/reconciler": &vfsgen۰DirInfo{
			name:    "reconciler",
			modTime: time.Date(2019, 9, 15, 14, 51, 26, 211073231, time.UTC),
		},
		"/reconciler/kabanero-landing": &vfsgen۰DirInfo{
			name:    "kabanero-landing",
			modTime: time.Date(2019, 9, 15, 14, 59, 34, 315745013, time.UTC),
		},
		"/samples": &vfsgen۰DirInfo{
			name:    "samples",
			modTime: time.Date(2019, 9, 16, 18, 13, 5, 518469734, time.UTC),
		},
		...
		"/versions.yaml": &vfsgen۰CompressedFileInfo{
			name:             "versions.yaml",
			modTime:          time.Date(2019, 9, 16, 19, 1, 55, 221363964, time.UTC),
	...
	fs["/reconciler"].(*vfsgen۰DirInfo).entries = []os.FileInfo{
		fs["/reconciler/kabanero-landing"].(os.FileInfo),
	}
